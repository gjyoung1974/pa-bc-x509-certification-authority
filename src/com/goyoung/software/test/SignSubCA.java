...
public class SignSubCA {
	...
	public static void main(String[] args) throws InvalidKeyException,
		...
		X500Principal sName = new X500Principal("CN=ACME Issuing CA, OU=ACME Certification Authority, O=ACME Inc, C=US");
		...
		// todo make this a vecor and add CAIssuer and OCSP both
		// AIA CACert list
		...
		certGen.addExtension(X509Extensions.ExtendedKeyUsage, false,EKUextension.getValue());
